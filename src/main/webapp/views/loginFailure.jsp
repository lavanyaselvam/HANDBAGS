...
.background {
	background-image: url("https://previews.123rf.com/images/rdzoomer/rdzoomer0807/rdzoomer080700931/3308440-glamorous-female-with-handbag-on-text-template-background-Stock-Photo.jpg");
	background-size:100%;
}
</style>
</head>
